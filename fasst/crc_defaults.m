...
% $Id: crc_defaults.m 407 2011-10-14 15:17:02Z christophe $
...
crc_def.gar.MrkStep        = 40 ;      % Number of marker between 2 successive volumes
...
crc_def.par.bcgrem.scSNR       = 4 ; % nr of signal std to consider signal as noise: abs(signal)>scSNR*max(std)
